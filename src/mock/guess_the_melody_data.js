const questions = [
  { category: `Pop`,
    data: [
    {
      ...
      image: './static/media/game_data/Pop/Bomfunk.jpg',
      audio: './static/media/game_data/Pop/Bomfunk.mp3'
    },
    {
      id: 2,
      name: 'Beatles',
      ...
      image: './static/media/game_data/Pop/beatles.jpg',
      audio: './static/media/game_data/Pop/beatles.mp3'
    },
    {
      id: 3,
      name: 'Sia',
      ...
      image: './static/media/game_data/Pop/sia.jpg',
      audio: './static/media/game_data/Pop/sia.mp3'
    },
    {
      id: 4,
      name: 'Zivert',
      ...
      image: './static/media/game_data/Pop/zivert.png',
      audio: './static/media/game_data/Pop/zivert.mp3',
    },
    {
      id: 5,
      name: 'Little Big',
      ...
      image: './static/media/game_data/Pop/skibidi.png',
      audio: './static/media/game_data/Pop/skibidi.mp3'
    },
    {
      id: 6,
      ...
      image: './static/media/game_data/Pop/thunder.jpg',
      audio: './static/media/game_data/Pop/thunder.mp3'
    }
    ]
  },
   ...
   data:  [
    {
      ...
      image: './static/media/game_data/Films_90/Terminator2.jpg',
      audio: './static/media/game_data/Films_90/Terminator2.mp3'
    },
    {
      id: 2,
      ...
      image: './static/media/game_data/Films_90/pulp_fiction.jpg',
      audio: './static/media/game_data/Films_90/pulp_fiction.mp3'
    },
    {
      id: 3,
      name: 'Такси',
      ...
      image: './static/media/game_data/Films_90/taxi.jpg',
      audio: './static/media/game_data/Films_90/taxi.mp3'
    },
    {
      id: 4,
      name: 'Один дома',
      ...
      image: './static/media/game_data/Films_90/home_alone.jpg',
      audio: './static/media/game_data/Films_90/home_alone.mp3'
    },
    {
      id: 5,
      name: 'Титаник',
      ...
      image: './static/media/game_data/Films_90/titanik.jpg',
      audio: './static/media/game_data/Films_90/titanik.mp3'
    },
    {
      id: 6,
      name: 'Робокоп 2',
      ...
      image: './static/media/game_data/Films_90/robokop2.jpg',
      audio: './static/media/game_data/Films_90/robokop2.mp3'
    }
    ]
  },
  ...
  data: [
  {
    ...
    image: './static/media/game_data/Rap/eminem.jpg',
    audio: './static/media/game_data/Rap/eminem.mp3'
  },
  {
    id: 2,
    name: ' K-Maro',
    ...
    image: './static/media/game_data/Rap/Kamar.jpg',
    audio: './static/media/game_data/Rap/Kamar.mp3'
  },
  {
    id: 3,
    name: 'Баста',
    ...
    image: './static/media/game_data/Rap/basta.png',
    audio: './static/media/game_data/Rap/basta.mp3'
  },
  {
    id: 4,
    name: '50 Cent',
    ...
    image: './static/media/game_data/Rap/50-cent.jpg',
    audio: './static/media/game_data/Rap/50-cent.mp3'
  },
  {
    id: 5,
    name: 'Грибы',
    ...
    image: './static/media/game_data/Rap/griby.jpg',
    audio: './static/media/game_data/Rap/griby.mp3'
  },
  {
    id: 6,
    name: 'Jah Khalib',
    species: 'Медина (2018)',
    description: 'Это собирательный образ. В "Медине" рассказывается о человеке, который заблудился на своем пути: это может быть что угодно. Напр./static/media/game_data/имер, человек был безответственным и в какой то момент решил исправиться.',
    image: './static/media/game_data/Rap/medina.jpg',
    audio: './static/media/game_data/Rap/medina.mp3'
  }
  ]
  },  
   ...
   data: [
    {
      ...
      image: './static/media/game_data/Films_2000/bumer.jpg',
      audio: './static/media/game_data/Films_2000/bumer.mp3'
    },
    {
      id: 2,
      ...
      image: './static/media/game_data/Films_2000/pirates.jpg',
      audio: './static/media/game_data/Films_2000/pirates.mp3'
    },
    {
      id: 3,
      name: 'Бригада',
      ...
      image: './static/media/game_data/Films_2000/brigada.jpg',
      audio: './static/media/game_data/Films_2000/brigada.mp3'
    },
    {
      id: 4,
      name: 'Большой куш',
      ...
      image: './static/media/game_data/Films_2000/snatch.jpg',
      audio: './static/media/game_data/Films_2000/snatch.mp3'
    },
    {
      id: 5,
      ...
      image: './static/media/game_data/Films_2000/oceans11.jpg',
      audio: './static/media/game_data/Films_2000/oceans11.mp3'
    },
    {
      id: 6,
      name: 'Бой с тенью',
      ...
      image: './static/media/game_data/Films_2000/tenj.jpg',
      audio: './static/media/game_data/Films_2000/tenj.mp3'
    }
    ]
  },
  ...
  { category: `Rock`,
    data: [
    {
      ...
      image: './static/media/game_data/Rock/lordi.jpeg',
      audio: './static/media/game_data/Rock/lordi.mp3'
    },
    {
      id: 2,
      name: 'Nirvana',
      ...
      image: './static/media/game_data/Rock/nirvana.png',
      audio: './static/media/game_data/Rock/nirvana.mp3'
    },    
    {
      id: 3,
      name: 'Scorpions',
      ...
      image: './static/media/game_data/Rock/scorpions.jpeg',
      audio: './static/media/game_data/Rock/scorpions.mp3'
    },
    {
      id: 4,
      name: 'Queen',
      ...
      image: './static/media/game_data/Rock/queen.png',
      audio: './static/media/game_data/Rock/queen.mp3'
    },
    {
      id: 5,
      name: 'Linkin Park',
      ...
      image: './static/media/game_data/Rock/numb.jpg',
      audio: './static/media/game_data/Rock/numb.mp3'
    },
    {
      id: 6,
      name: 'Король и шут',
  ...
  {category: `Dendy games`,
    data: [       
      ...
      },
      {
        ...
        image: './static/media/game_data/Dandy_games/TMN3.jpeg',
        audio: './static/media/game_data/Dandy_games/TMN3.mp3'
      },
      {
        id: 4,
        ...
        image: './static/media/game_data/Dandy_games/BT-DD.jpg',
        audio: './static/media/game_data/Dandy_games/BT-DD.mp3'
      },
      {
        id: 5,
        ...
        image: './static/media/game_data/Dandy_games/super-mario.jpg',
        audio: './static/media/game_data/Dandy_games/super-mario.mp3'
      },
      {
        id: 6,
        ...
        image: './static/media/game_data/Dandy_games/batle-city.jpeg',
        audio: './static/media/game_data/Dandy_games/batle-city.mp3'
      }
    ]
  },
];
